...
__all__ = [
    ...
    "FixedLengthGreedyEmbeddingHelper",
...
class FixedLengthGreedyEmbeddingHelper(Helper):
  """A helper for use during inference.

  Uses the argmax of the output (treated as logits) and passes the
  result through an embedding layer to get the next input.
  untill, a certain number of words are decoded
  """

  def __init__(self, embedding, start_tokens, sequence_length):
    """Initializer.
